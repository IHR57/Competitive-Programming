//Date: 31/10/19
//Problem Link: https://acmp.ru/asp/do/index.asp?main=task&id_course=2&id_section=18&id_topic=43&id_problem=284
#include <bits/stdc++.h>
#define pb push_back
#define mk make_pair
#define ff first
...
int main()
{
    ...
    for(int i = 1; i < n; i++){
        ...
        if(str[p1+ans] > str[p2+ans])
            p1 = p2;
        //cout<<p1<<" "<<p2<<endl;
    }

    cout<<str.substr(p1, n)<<endl;
